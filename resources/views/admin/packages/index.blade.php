    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <div class="container">
                    <h2 class="mb-4 text-left">Packages</h2>
                    <div class="d-flex justify-content-end mb-3">
                        <a href="{{ url('/admin/packages/create') }}" class="btn btn-primary">
                            Create Package
                        </a>
                    </div>
                        ...
                        <tbody>
                            @foreach ($package as $key => $item)
                                <tr>
                                    ...
                                    <td>{{ $item->price }}</td>
                                    <td>
                                        <a href="{{ route('packages.edit-package', $item->id) }}" class="btn btn-sm btn-primary">Edit</a>
                    ...
                    <div class="container mt-4">
                        ...
                        <div class="d-flex justify-content-center mt-4">
                            <ul class="pagination">
                                ...
                                <!-- Page Numbers -->
                                @foreach(range(1, $package->lastPage()) as $i)
                                    <li class="page-item {{ $package->currentPage() == $i ? 'active' : '' }}">
...
document.getElementById('search-btn').addEventListener('click', function() {
    ...
    if (query.length > 0) {
        fetch('/search?query=' + encodeURIComponent(query)) // Ensure the query is properly encoded
        ...
        // If no query is entered, show a message or do nothing
